...
public class Player {
    ...
    public void move(Map map, char movecode) {
    ...
    public void switchActiveEngimon(Map map, int new_eng_id) {
    ...
    public void setActiveEngimonPosition(Map map, Tile tile) {
        // set occupier in map
        // map.setTile(x, y, 'X')
    ...
    public Tile isThereAnyEnemyAround(Map map) throws Exception {
